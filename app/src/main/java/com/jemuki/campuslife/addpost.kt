...
class addpost : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val back = findViewById<ImageButton>(R.id.addback)
        ...
        //send = findViewById(R.id.sendpostnow)
        sendpostnow.setOnClickListener {
    ...
    private fun uploadall(pimg: ArrayList<String>) {
        ...
        val thepost = findViewById<EditText>(R.id.typepost)
        ...
        val prefs3 = getSharedPreferences("mshowdb", Context.MODE_PRIVATE)
        ...
        //post it to api
        client.post(this, "http://coding.co.ke/jereson/addpost2",
    ...
    private fun uploadsome(){
        ...
        //post it to api
        client.post(this, "http://coding.co.ke/jereson/addpost1",
            condata, "application/json",
            object: JsonHttpResponseHandler() {
                override fun onSuccess(
                    statusCode: Int,
